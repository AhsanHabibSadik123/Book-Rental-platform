            ...
            <div class="col-auto">
                <div class="card text-white bg-primary text-center">
                    <div class="card-body py-2">
                        ...
                        <div class="fw-bold fs-5">{{ $books->total() }}</div>
            ...
            <div class="col-auto">
                <div class="card text-white bg-success text-center">
                    <div class="card-body py-2">
                        ...
                        <div class="fw-bold fs-5">{{ $books->where('status', 'available')->count() }}</div>
            ...
            <div class="col-auto">
                <div class="card text-white bg-warning text-center">
                    <div class="card-body py-2">
                        ...
                        <div class="fw-bold fs-5">{{ $books->where('status', 'rented')->count() }}</div>
